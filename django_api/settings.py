...
SECRET_KEY = 'django-insecure-^es36_4)k@avguhsj*$eg2)r4*t!ot$!_apitymg#er_(y$)c3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['testimony.pythonanywhere.com']
...
CORS_ALLOWED_ORIGINS = [
    "https://react-blog-pearl-rho.vercel.app",  # Your Vercel frontend
